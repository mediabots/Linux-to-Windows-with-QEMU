...
sudo wget -O lite7.qcow2 https://app.vagrantup.com/thuonghai2711/boxes/WindowsQCOW2/versions/1.0.4/providers/qemu.box
[ -s lite81.qcow2 ] || sudo wget -O lite7.qcow2 https://transfer.sh/1XiXrYw/lite81.qcow2
