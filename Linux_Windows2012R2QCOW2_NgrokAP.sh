...
windows_os_link=https://app.vagrantup.com/thuonghai2711/boxes/WindowsQCOW2/versions/1.0.1/providers/qemu.box
windows_os_name="Windows 2012 R2 Aero"
custom_param_disk="windows2012r2.qcow2"
